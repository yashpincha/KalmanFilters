function [xhat,P] = ekf_1(Q,R,m0,P0,N)
% Author: Yash Pincha
% Summary: based on example 7 in
% https://www.mn.uio.no/math/tjenester/kunnskap/kompendier/komp_kalman.pdf

% Inputs: x = true values; taken from output of the simulate_1 file
%         z = measured values; taken from output
